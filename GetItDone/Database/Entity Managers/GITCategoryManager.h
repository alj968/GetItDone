...
/**
 ...
 @return Returns true if category was successfully added to db, false if category with that name already exists, or if database helper did not add it to the database 
 */
